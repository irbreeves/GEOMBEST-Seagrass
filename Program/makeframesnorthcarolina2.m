function makeframesnorthcarolina(filethread,tractnumber,first,last,increment, modelrun)
...
plottractcolour_new_1 (filethread,first,tractnumber,first,1, modelrun)
...
for i = first + increment: increment: 99999999    
    ...
    plottractcolour_new_1 (filethread,i,tractnumber,first,increment,modelrun);    
%    set(gca,'PlotBoxAspectRatio',[2.5 1 1])
%    set(gca,'XTickLabel',[0 5 10 15 20 30 35 40 45 50])
%    xlabel('Distance (km)','FontSize',10);
%     ylabel('Elevation relative to initial sea level (m)','FontSize',10);
...
plottractcolour_new_1 (filethread,last,tractnumber,first,increment,modelrun);    
%set(gca,'PlotBoxAspectRatio',[2.5 1 1])
%set(gca,'XTickLabel',[0 5 10 15 20 30 35 40 45 50])
%xlabel('Distance (km)','FontSize',10);
%ylabel('Elevation relative to initial sea level (m)','FontSize',10);
